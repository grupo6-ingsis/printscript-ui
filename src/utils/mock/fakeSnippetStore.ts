...
const INITIAL_SNIPPETS: Snippet[] = [
    {
        ...
        description: 'A simple snippet for addition' // Added description
    },
    {
        ...
        extension: 'prs',
        version: '1.0', // Added version
        description: 'An extra cool snippet example' // Added description
    },
    {
        ...
        extension: 'prs',
        version: '1.0', // Added version
        description: 'A boring snippet example' // Added description
    }
];
